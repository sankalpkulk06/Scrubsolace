...
import sarangpic from "./sarangpic.jpeg";
import sathwickpic from "./sathwick.jpg";
    ...
    <div>
      <div className="banner-area">
        ...
        <div className="box" className="styles">
          ...
          <Box1 image={sathwickpic} names="Sathwick" desgn="Developer" />
          <Box1 image={sarangpic} names="Sarang" desgn="Developer" />
        </div>
      </div>
    </div>
  );
